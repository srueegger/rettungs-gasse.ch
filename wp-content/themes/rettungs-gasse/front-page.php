		...
		<div class="container mt-5">
			<div class="row">
				<div class="col-12">
					...
					?>
					<h2 class="text-center">TITEL DER SEKTION</h2>
				</div>
			</div>
			<div class="row mt-3">
				<?php
					...
					<div class="col-12 col-md-6 col-lg-4">
						<div class="front-social-container">
							<h3 class="mt-3">Rettungs Gasse auf Social Media</h3>
							<a href=""><img class="img-fluid" src="https://via.placeholder.com/600x600" alt="Rettungs Gasse auf Social Media"></a>
						</div>
					</div>
					<?php
					//Aktuellster Event
