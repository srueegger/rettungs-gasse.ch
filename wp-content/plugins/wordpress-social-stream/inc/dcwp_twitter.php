...
$consumer_key = $dcwss_options['settings']['consumer_key'];
$consumer_secret = $dcwss_options['settings']['consumer_secret'];
$oauth_access_token = $dcwss_options['settings']['access_token'];
$oauth_access_token_secret = $dcwss_options['settings']['access_token_secret'];
...
switch($url_type)
{
	...
	$params = Array('count' => $_GET['count'], 'include_rts' => $include_rts, 'exclude_replies' => $_GET['exclude_replies'], 'screen_name' => $_GET['screen_name'], 'tweet_mode' => 'extended');
	break;
	case 'search':
	$rest = "search/tweets";
	$params = Array('q' => $_GET['q'], 'count' => $_GET['count'], 'include_rts' => $include_rts, 'tweet_mode' => 'extended');
	break;
	case 'list':
	$rest = "lists/statuses";
	$params = Array('list_id' => $_GET['list_id'], 'count' => $_GET['count'], 'include_rts' => $include_rts, 'tweet_mode' => 'extended');
	break;
	default:
	$rest = 'statuses/user_timeline' ;
