...
class dc_jqsocialstream {
	...
	function add_dcwss_scripts() {
		...
		wp_enqueue_script( 'dcwss-wall', plugins_url() . '/wordpress-social-stream/js/jquery.social.stream.wall.1.8.js', array('jquery-migrate') );
		wp_enqueue_script( 'dcwss', plugins_url() . '/wordpress-social-stream/js/jquery.social.stream.1.6.2.min.js', array('jquery-migrate') );
